              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    ...
                    <a rel="{{ $product->id}}"  rell="delete-product" href="javascript:" class="btn btn-danger btn-mini deleteRecord">Delete</a>
                    <a href="{{ url('/admin/add-attributes/'.$product->id )}}"  class="btn btn-success btn-mini">Add Attribute</a>
                  </td>
                </tr>
