...
<head>
        ...
        <link href="{{ asset('fonts/backend_fonts/font/css/font-awesome.css') }}" rel="stylesheet" />
        ...
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="{{ url('admin') }}" method="post">
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><input type="submit" value="submit" name="submit" class="btn btn-success" /></span>
                </div>
            </form>
